...
public inline fun messageRequest(block: grpc_code_gen.chat.message.MessageRequestKt.Dsl.() -> kotlin.Unit): grpc_code_gen.chat.message.Message.MessageRequest =
  grpc_code_gen.chat.message.MessageRequestKt.Dsl._create(grpc_code_gen.chat.message.Message.MessageRequest.newBuilder()).apply { block() }._build()
public object MessageRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: grpc_code_gen.chat.message.Message.MessageRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: grpc_code_gen.chat.message.Message.MessageRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): grpc_code_gen.chat.message.Message.MessageRequest = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun grpc_code_gen.chat.message.Message.MessageRequest.copy(block: grpc_code_gen.chat.message.MessageRequestKt.Dsl.() -> kotlin.Unit): grpc_code_gen.chat.message.Message.MessageRequest =
  grpc_code_gen.chat.message.MessageRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()
